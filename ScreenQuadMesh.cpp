...
namespace AlbinoEngine
{
	...
	bool ScreenQuadMesh::initliaze()
	{
		...
		m_pMeshDevice->CreateBuffer(&vertDesc, &vertData, m_pMeshVertBuffer.ReleaseAndGetAddressOf());

		D3D11_BUFFER_DESC indexDesc = {};
		indexDesc.Usage = D3D11_USAGE_DEFAULT;
		indexDesc.ByteWidth = indexSize;
		...
		m_pMeshDevice->CreateBuffer(&indexDesc, &indexData, m_pMeshIndexBuffer.ReleaseAndGetAddressOf());
